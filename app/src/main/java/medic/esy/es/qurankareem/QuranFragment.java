...
public class QuranFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        name = (ImageView) rootView.findViewById(R.id.tv_name);
        page = (EditText) rootView.findViewById(R.id.tv_page);
        detaillayout = (CardView) rootView.findViewById(R.id.detaillayout);
...
////////
    ...
    private void saveBookMark(int pos) {
        int p = 603 - pos;
        getContext().getSharedPreferences("quran",0).edit().clear().commit();
        ...
        getContext().getSharedPreferences("quran", Context.MODE_PRIVATE).edit().putString("item_" + size, "الصفحه رقم  " + (p + 1)).commit();
        getContext().getSharedPreferences("quran", Context.MODE_PRIVATE).edit().putInt("list", (size + 1)).commit();

        final Toast toast = Toast.makeText(getContext(), "The marker about this page is saved Check your Marker", Toast.LENGTH_SHORT);
        ...
        toastView.setBackgroundColor(Color.parseColor("#BD948B"));
        toast.setGravity(Gravity.CENTER, 16, 0);
        toast.show();
