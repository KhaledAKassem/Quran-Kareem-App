...
public class Fragment8 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        int num  = getContext().getSharedPreferences("quran", Context.MODE_PRIVATE).getInt("list", 0);
    ...
    class RecyAdapter extends RecyclerView.Adapter<Holder> {
        ...
        public void onBindViewHolder(@NonNull final Holder holder, final int position) {
            holder.index.setText("" + (position + 1));
                holder.itemView.setBackgroundColor(0x7FFF0000);
            if (position + 1 == strings.size()){

                holder.iv.setImageResource(R.drawable.delete_swipe);
//                holder.iv.setBackgroundColor(0xFF00FF00);
